...
func checkRange(s int32, t int32, treePosition int32, fruits []int32, result *int) {
	for _, x := range fruits {
		fruitPosition := treePosition + x
...
func countApplesAndOranges(s int32, t int32, a int32, b int32, apples []int32, oranges []int32) {
	var applesOnHouse, orangesOnHouse int = 0, 0
	checkRange(s, t, a, apples, &applesOnHouse)
	checkRange(s, t, b, oranges, &orangesOnHouse)
